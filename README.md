...
**Archived release:** This repository is permanently archived on Zenodo with a versioned DOI: [10.5281/zenodo.21842981](https://doi.org/10.5281/zenodo.21842981)
...
5. **Threshold justification** - parameter sweep over Cliff's δ and the variance scaling constant; consensus-curve check showing that the male core declines gradually with increasing LOSO threshold, without the abrupt collapse seen in females.
...
| **Reproducible stable core (LOSO ≥ 0.7)** | **female 146 (8%, threshold-sensitive); male 514 (60%, comparatively stable)**; shared 3 |
